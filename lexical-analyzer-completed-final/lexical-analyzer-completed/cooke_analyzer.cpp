/*
=============================================================================
Title : cooke_analyzer.cpp
Description : This is a lexical analyzer for lexems for simple text
Author : Aidan Burchett R11837228
Date : 11/6/2024
Version : 1.0
Usage : Compile and run this program using the GNU C++ compiler
Notes : Make advantage of the Makefile
...
/* look up for special characters within the program*/
static int lookup(char ch) {
    switch (ch) {
        /* Check to see if it's double equals or just one equals*/
        case '=':
            addChar();
            getChar();
            if(nextChar == '=') {
    ...
    /* getChar again for the times it didn't return in the if-else statement*/
    getChar();
    return nextToken;
}
...
int main(int argc, char* argv[]) {
    ...
    if (in_fp == NULL) {
        ...
        do {
            lex();
            /*Don't need expr for this project*/
            //expr();
        } while (nextToken != EOF);
    }
    return 0;
