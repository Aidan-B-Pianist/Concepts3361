...
void factor()
{
    ...
    /* Determine which RHS */
    if (nextToken == IDENT || nextToken == INT_LIT || nextToken == ASSIGN_OP)
    {
            ...
            if(nextToken == OPEN_PAREN)
            {
                ...
                if(nextToken == OPEN_CURL) {
                    ...
                    while(nextToken != CLOSE_CURL) {
                        counter++;
                        lex();
                        if(counter == 1000 || nextToken == KEY_ELSE) {
                            error();
                        }
                    }
                }
        ...
        case KEY_ELSE:
                lex();
                    if(nextToken == OPEN_CURL) {
                        ...
                        counter++;
                        lex();
                        //if no close curl wait 10000 iterations before throwing error
                        if(counter == 10000) {
                            error();
                        }
                    }
